...
//   var test2 = document.getElementsByClassName("accordion-toggle")[2].getElementsByClassName("down-arrow")[0];
//   $(accordion).append(arrow_right);
//   $(test2).remove();
//   /*accordion.removeChild(test2);*/
//   $(accordion).attr("href","#");
//   $(accordion).attr("data-toggle","");
// });