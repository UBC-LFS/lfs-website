...
jQuery(document).ready(function ($) {
  ...
  (function () {
    Date.Parsing = { Exception: function (s) { this.message = "Parse error at '" + s.substring(0, 10) + " ...'" } }; var $P = Date.Parsing; var _ = $P.Operators = {
      ...
      between: function (d1, p, d2) { d2 = d2 || d1; var _fn = _.each(_.ignore(d1), p, _.ignore(d2)); return function (s) { var rx = _fn.call(this, s); return [[rx[0][0], r[0][2]], rx[1]] } },
    ...
    var $D = Date, $P = $D.prototype, $C = $D.CultureInfo; var flattenAndCompact = function (ax) {
      ...
      year: function (s) { return function () { var n = Number(s); this.year = ((s.length > 2) ? n : (n + (((n + 2000) < $C.twoDigitYearMax) ? 2000 : 1900))) } },
  ...
  var CheckOpenClosed = function () {
    ...
    var isMonday = function () {
      return ((dayofweek == 1) && (hours >= 7)) || ((dayofweek == 2) && (hours < 7))
    }

    var isTuesday = function () {
      return ((dayofweek == 2) && (hours >= 7)) || ((dayofweek == 3) && (hours < 7))
    }

    var isWednesday = function () {
      return ((dayofweek == 3) && (hours >= 7)) || ((dayofweek == 4) && (hours < 7))
    }

    var isThursday = function () {
      return ((dayofweek == 4) && (hours >= 7)) || ((dayofweek == 5) && (hours < 7))
    }

    var isFriday = function () {
      return ((dayofweek == 5) && (hours >= 7)) || ((dayofweek == 6) && (hours < 7))
    }

    var isSaturday = function () {
      return ((dayofweek == 6) && (hours >= 7)) || ((dayofweek == 0) && (hours < 7))
    }

    var isSunday = function () {
      return ((dayofweek == 0) && (hours >= 7)) || ((dayofweek == 1) && (hours < 7))
    }
    ...
    if (isMonday()) {
      $('.open-circle-tuesday').css('display', 'none')
      $('.open-circle-wednesday').css('display', 'none')
      $('.open-circle-thursday').css('display', 'none')
      $('.open-circle-friday').css('display', 'none')
      $('.open-circle-saturday').css('display', 'none')
      $('.open-circle-sunday').css('display', 'none')
      if (opencheck == 1) {
        $('.open-circle-monday').css('background', '#02d738')
      } else {
        $('.open-circle-monday').css('background', '#de1309')
      }
    }

    if (isTuesday()) {
      $('.open-circle-monday').css('display', 'none')
      $('.open-circle-wednesday').css('display', 'none')
      $('.open-circle-thursday').css('display', 'none')
      $('.open-circle-friday').css('display', 'none')
      $('.open-circle-saturday').css('display', 'none')
      $('.open-circle-sunday').css('display', 'none')
      if (opencheck == 1) {
        $('.open-circle-tuesday').css('background', '#02d738')
      } else {
        $('.open-circle-tuesday').css('background', '#de1309')
      }
    }
    ...
    if (isWednesday()) {
      ...
      $('.open-circle-sunday').css('display', 'none')
      if (opencheck == 1) {
        $('.open-circle-wednesday').css('background', '#02d738')
      } else {
        $('.open-circle-wednesday').css('background', '#de1309')
      }
    }
    ...
    if (isThursday()) {
      ...
      $('.open-circle-sunday').css('display', 'none')
      if (opencheck == 1) {
        $('.open-circle-thursday').css('background', '#02d738')
      } else {
        $('.open-circle-thursday').css('background', '#de1309')
      }
    }
    ...
    if (isFriday()) {
      ...
      $('.open-circle-sunday').css('display', 'none')
      if (opencheck == 1) {
        $('.open-circle-friday').css('background', '#02d738')
      } else {
        $('.open-circle-friday').css('background', '#de1309')
      }
    }
    ...
    if (isSaturday()) {
      ...
      $('.open-circle-saturday').css('background', '#de1309')
    }
